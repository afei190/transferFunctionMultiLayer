...
public:
    ...
    QVector<QString> getthicknessVec() {return thicknessVec;}
    QVector<QString> getvsVec() {return vsVec;}
    QVector<QString> getesizeVec() {return esizeVec;}
    QVector<QString> getdensityVec() {return densityVec;}
    ...
    Q_INVOKABLE double getVS(int row)
    {
        return data(createIndex(row,VS)).toDouble();
    }

    Q_INVOKABLE double getDensity(int row)
    {
        return data(createIndex(row,DENSITY)).toDouble();
    }

    Q_INVOKABLE double getESize(int row)
    {
        return data(createIndex(row,ESIZE)).toDouble();
    }
